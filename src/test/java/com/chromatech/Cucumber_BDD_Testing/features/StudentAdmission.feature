Feature: Student Admission Scenario
  ...
  Scenario: Student Admission Scenario
    ...
    And if the record admission number "0072" exists user clicks on the checkbox
    ...
    And enters Unique Admission Number "0072"
    ...
    And clicks on the Search button
    When the user is on the "https://mexil.it/chroma/student/bulkdelete" page
    And clicks on the checkbox with the unique admission number "0072"
  ...
  Scenario Outline: Admitting Multiple Students Scenario
    ...
    Examples:
      ...
      | 00062         | 365                | Mike       | Goldberg  | Male   | 02/02/1964    | mikeGoldberg@post.net    | 11/03/2024     | A+         | 07/10/2020    | 6'11   | 170    | Martin        | 767-212-5609          | Dentist             | Rachel        | 444-512-3487          | rachel1977@gmail.com     | Carpenter           | 643 Trump Ave, Charlotte, NC       |
