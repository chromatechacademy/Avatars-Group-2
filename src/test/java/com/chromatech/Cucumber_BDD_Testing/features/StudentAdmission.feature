Feature: Student Admission Scenario
  ...
  Scenario Outline: Admitting Multiple Students Scenario
    ...
    Examples:
      ...
      | 0012          | 028                | Chris      | Bernie    | Male   | 10/08/1977    | chris.bernie@aol.com     | 11/20/2014     | B+         | 02/18/2021    | 5'5    | 146    | Keith         | 766-923-7454          | Mechanic            | Rebecca       | 744-154-7002          | rebecca.ber@yahoo.com    | Astronaut           | 1 King's Plaza, Albany, NY         |