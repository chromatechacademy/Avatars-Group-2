...
public class StepsImplementation extends PageInitializer {
    ...
    /**
     * Logs a screenshot and validates the displayed submodules.
     *
     * @param expectedSubmodules The list of expected submodules to be displayed.
     */
    public static void the_following_submodules_displays(List<String> expectedSubmodules) {
        CucumberLogUtils.logScreenShot();
        List<String> actualSubmodules = new ArrayList<>();
